...
function dl_enqueue_style() {
	...
	wp_register_style( 'mi_estilo', get_theme_file_uri('/assets/css/main.css'), $deps, $theme_data->get('Version'), 'screen' );
	wp_register_style( 'google_font', 'https://fonts.googleapis.com/css?family=Lobster|Open+Sans:400,700,700i&display=swap' );
